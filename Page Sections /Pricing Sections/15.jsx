            ...
            <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-2 lg:px-8">
                ...
                <span className="flex flex-col text-center">
                  ...
                  <span className="sr-only">plus</span>
                                ...
                                >
                  <PlusIcon aria-hidden="true" className="h-6 w-6 text-indigo-300" />
                </span>
                                <span>
                  <span className="flex flex-col text-center">
                    ...
                    <span className="mt-2 text-base font-medium text-indigo-200">Per month</span>
                        ...
                        <ul role="list" className="grid gap-px overflow-hidden rounded sm:grid-cols-2">
                            {checklist.map((item) => (
                                <li
                                    key={item}
                                    className="flex items-center space-x-3 bg-indigo-800 bg-opacity-50 px-4 py-4 text-base text-white"
                                >
                                    <CheckIcon aria-hidden="true" className="h-6 w-6 text-indigo-300" />
                                    <span>{item}</span>
                                </li>
                            ))}
                        </ul>
