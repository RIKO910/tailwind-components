                        ...
                        <div className="relative flex flex-wrap items-center justify-center lg:justify-between">
                            ...
                            <div className="absolute left-0 flex-shrink-0 py-5 lg:static">
                                <a href="#">
                                    ...
                                    <img
                                        alt=""
                                        src="https://tailwindui.com/plus/img/logos/mark.svg?color=cyan&shade=200"
                            ...
                            <div className="absolute right-0 flex-shrink-0 lg:hidden">
                                {/* Mobile menu button */}
                                <PopoverButton className="group relative inline-flex items-center justify-center rounded-md bg-transparent p-2 text-cyan-200 hover:bg-white hover:bg-opacity-10 hover:text-white focus:outline-none focus:ring-2 focus:ring-white">
                          ...
                          <svg fill="currentColor" viewBox="0 0 24 24" className="h-6 w-6">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                ...
                                <section aria-labelledby="announcements-title">
                                    <div className="overflow-hidden rounded-lg bg-white shadow">
                                        <div className="p-6">
                                            <h2 id="announcements-title" className="text-base font-medium text-gray-900">
                                                Announcements
                                            </h2>
                                ...
                                <section aria-labelledby="recent-hires-title">
                                    <div className="overflow-hidden rounded-lg bg-white shadow">
                                        <div className="p-6">
                                            <h2 id="recent-hires-title" className="text-base font-medium text-gray-900">
                                                Recent Hires
                                            </h2>
                                            <div className="mt-6 flow-root">
                                                <ul role="list" className="-my-5 divide-y divide-gray-200">
