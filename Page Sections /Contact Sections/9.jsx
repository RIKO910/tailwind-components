                        ...
                        <div className="relative overflow-hidden bg-indigo-700 px-6 py-10 sm:px-10 xl:p-12">
                            ...
                            <dl className="mt-8 space-y-6">
                                ...
                                <dd className="flex text-base text-indigo-50">
                                    <PhoneIcon aria-hidden="true" className="h-6 w-6 flex-shrink-0 text-indigo-200" />
                                ...
                                <dd className="flex text-base text-indigo-50">
                                    <EnvelopeIcon aria-hidden="true" className="h-6 w-6 flex-shrink-0 text-indigo-200" />
