...
const logos = [
    { name: 'Transistor', url: 'https://tailwindui.com/plus/img/logos/transistor-logo-gray-400.svg' },
    { name: 'Mirage', url: 'https://tailwindui.com/plus/img/logos/mirage-logo-gray-400.svg' },
    { name: 'Tuple', url: 'https://tailwindui.com/plus/img/logos/tuple-logo-gray-400.svg' },
    { name: 'Laravel', url: 'https://tailwindui.com/plus/img/logos/laravel-logo-gray-400.svg' },
    { name: 'StaticKit', url: 'https://tailwindui.com/plus/img/logos/statickit-logo-gray-400.svg' },
    { name: 'Workcation', url: 'https://tailwindui.com/plus/img/logos/workcation-logo-gray-400.svg' },
]
        ...
        <div className="bg-white">
                                ...
                                <div className="mt-6">
                                    <div className="inline-flex items-center divide-x divide-gray-300">
                                        <div className="flex flex-shrink-0 pr-5">
                                            <StarIcon aria-hidden="true" className="h-5 w-5 text-yellow-400" />
                                            <StarIcon aria-hidden="true" className="h-5 w-5 text-yellow-400" />
                                            <StarIcon aria-hidden="true" className="h-5 w-5 text-yellow-400" />
                                            <StarIcon aria-hidden="true" className="h-5 w-5 text-yellow-400" />
                                            <StarIcon aria-hidden="true" className="h-5 w-5 text-yellow-400" />
                        ...
                        <div className="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                            <div className="hidden sm:block">
                                ...
                                >
                                    ...
                                    <rect fill="url(#837c3e70-6c3a-44e6-8854-cc48c737b659)" width={404} height={392} />
                                </svg>
                            </div>
                            <div className="relative -mr-40 pl-6 sm:mx-auto sm:max-w-3xl sm:px-0 lg:h-full lg:max-w-none lg:pl-12">
                                <img
                                    alt=""
                                    src="https://tailwindui.com/plus/img/component-images/task-app-rose.jpg"
                        ...
                        <div className="relative sm:py-16 lg:py-0">
                            <div aria-hidden="true" className="hidden sm:block lg:absolute lg:inset-y-0 lg:right-0 lg:w-screen">
                                ...
                                >
                                    ...
                                    <rect fill="url(#02f20b47-fd69-4224-a62a-4c9de5c763f7)" width={404} height={392} />
                                </svg>
                            </div>
                                ...
                                <div className="relative overflow-hidden rounded-2xl pb-10 pt-64 shadow-xl">
                                    ...
                                    <div className="relative px-8">
                                        <div>
                                            <img
                                                alt="Workcation"
                                                src="https://tailwindui.com/plus/img/logos/workcation.svg?color=white"
                                                className="h-12"
                                            />
                                        </div>
            ...
            <footer className="mt-24 bg-gray-900 sm:mt-12">
                <div className="mx-auto max-w-md overflow-hidden px-6 py-12 sm:max-w-3xl lg:max-w-7xl lg:px-8">
                    <nav aria-label="Footer" className="-mx-5 -my-2 flex flex-wrap justify-center">
