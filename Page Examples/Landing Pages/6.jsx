            ...
            <div className="relative overflow-hidden">
                <Popover as="header" className="relative">
                            ...
                            <div className="flex flex-1 items-center">
                                <div className="flex w-full items-center justify-between md:w-auto">
                                    <a href="#">
                                        ...
                                        <img
                                            alt=""
                                            src="https://tailwindui.com/plus/img/logos/mark.svg?from-color=teal&from-shade=200&to-color=cyan&to-shade=400&toShade=400"
                    ...
                    <PopoverPanel
                        focus
                        transition
                        className="absolute inset-x-0 top-0 origin-top transform p-2 transition data-[closed]:scale-95 data-[closed]:opacity-0 data-[enter]:duration-150 data-[leave]:duration-100 data-[enter]:ease-out data-[leave]:ease-in md:hidden"
                    >
                        <div className="overflow-hidden rounded-lg bg-white shadow-md ring-1 ring-black ring-opacity-5">
                            <div className="flex items-center justify-between px-5 pt-4">
                                <div>
                                    <img
                                        alt=""
                                        src="https://tailwindui.com/plus/img/logos/mark.svg?from-color=teal&from-shade=500&to-color=cyan&to-shade=600&toShade=600"
                                        className="h-8 w-auto"
                                    />
                                </div>
                                <div className="-mr-2">
                                    <PopoverButton className="relative inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-cyan-600">
                                        <span className="absolute -inset-0.5" />
                    ...
                    <div className="bg-gray-900 pt-10 sm:pt-16 lg:overflow-hidden lg:pb-14 lg:pt-8">
                      ...
                      <span className="rounded-full bg-gradient-to-r from-teal-500 to-cyan-600 px-3 py-0.5 text-sm font-semibold leading-5 text-white">
                        We're hiring
                                            ...
                                            <ChevronRightIcon aria-hidden="true" className="ml-2 h-5 w-5 text-gray-500" />
                                        </a>
                    ...
                    <div className="relative bg-gray-50 pt-16 sm:pt-24 lg:pt-32">
                        <div className="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
                            ...
                            <div className="-mb-10 mt-12 sm:-mb-24 lg:-mb-80">
                                <img
                                    alt=""
                                    src="https://tailwindui.com/plus/img/component-images/green-project-app-screenshot.jpg"
                                            ...
                                            <div className="mt-6 flex items-center">
                                                <div className="flex-shrink-0">
                                                    <a href={post.author.href}>
                                                        <img alt={post.author.name} src={post.author.imageUrl} className="h-10 w-10 rounded-full" />
                                                    </a>
                                                </div>
                                                <div className="ml-3">
                                ...
                                <div className="mt-8">
                                    <div className="inline-flex rounded-md shadow">
                                        ...
                                        >
                                            ...
                                            <ArrowTopRightOnSquareIcon aria-hidden="true" className="-mr-1 ml-3 h-5 w-5 text-gray-400" />
                                        </a>
                                    </div>
                                </div>
                            </div>
