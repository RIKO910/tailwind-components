                        ...
                        <div className="flex min-h-0 flex-1 flex-col border-r border-gray-200 bg-gray-100">
                            ...
                            <div className="flex flex-shrink-0 border-t border-gray-200 p-4">
                                <a href="#" className="group block w-full flex-shrink-0">
                                    <div className="flex items-center">
                                        <div>
                                            <img alt="" src={user.imageUrl} className="inline-block h-9 w-9 rounded-full" />
                                        </div>
                                        <div className="ml-3">
                                        ...
                                        <div className="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
                                            ...
                                            <div className="mt-6 sm:flex sm:min-w-0 sm:flex-1 sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                                                ...
                                                <div className="mt-6 flex flex-col justify-stretch space-y-3 sm:flex-row sm:space-x-4 sm:space-y-0">
                                                    ...
                                                    >
                                                        <EnvelopeIcon aria-hidden="true" className="-ml-0.5 h-5 w-5 text-gray-400" />
                                                        Message
                                                    </button>
                                                    <button
                                                        type="button"
                                                        className="inline-flex justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                                                    >
                                                        <PhoneIcon aria-hidden="true" className="-ml-0.5 h-5 w-5 text-gray-400" />
                                                        Call
                                                    </button>
                                                </div>
                                            </div>
