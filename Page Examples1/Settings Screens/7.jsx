      ...
      */}
            <div className="flex h-full">
                <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="relative z-40 lg:hidden">
                    <DialogBackdrop
                        transition
                        className="fixed inset-0 bg-slate-600 bg-opacity-75 transition-opacity duration-300 ease-linear data-[closed]:opacity-0"
                    />
                                ...
                                <a href="#" className="group block flex-shrink-0">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-3">
                                            ...
                                            <p className="text-sm font-medium text-slate-500 group-hover:text-slate-700">Account Settings</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <nav aria-label="Breadcrumb" className="border-b border-slate-200 bg-white xl:hidden">
                                <div className="mx-auto flex max-w-3xl items-start px-4 py-3 sm:px-6 lg:px-8">
                                    <a href="#" className="-ml-1 inline-flex items-center space-x-3 text-sm font-medium text-slate-900">
                                        <ChevronLeftIcon aria-hidden="true" className="h-5 w-5 text-slate-400" />
                                        <span>Settings</span>
                                    </a>
                                </div>
                            </nav>
                                ...
                                >
                                    ...
                                    <div className="min-h-0 flex-1 overflow-y-auto">
                                        {subNavigation.map((item) => (
                                            ...
                                            >
                                                <item.icon aria-hidden="true" className="-mt-0.5 h-6 w-6 flex-shrink-0 text-slate-400" />
