...
export default function Example() {
    return (
        <div className="bg-white">
            <header className="relative bg-slate-800 pb-36">
                <div className="absolute inset-0">
                    ...
                    />
                    <div aria-hidden="true" className="absolute inset-0 bg-slate-800 mix-blend-multiply" />
                </div>
                <Popover className="relative z-10">
                    ...
                    >
                        <div className="flex flex-1 items-center">
                            <div className="flex w-full items-center justify-between lg:w-auto">
                                ...
                                <div className="-mr-2 flex items-center lg:hidden">
                                    <PopoverButton className="focus-ring-inset relative inline-flex items-center justify-center rounded-md bg-slate-900 bg-opacity-0 p-2 text-white hover:bg-opacity-100 focus:outline-none focus:ring-2 focus:ring-white">
                        ...
                        <div className="hidden lg:flex lg:items-center lg:space-x-6">
                            <a
                                href="#"
                                className="rounded-md border border-transparent bg-blue-500 px-6 py-2 text-base font-medium text-white shadow-md hover:bg-blue-600"
                            >
                                Login
                            </a>
                        </div>
                    ...
                    >
                        <div className="overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                            <div className="flex items-center justify-between px-5 pt-4">
                                ...
                                <div className="-mr-2">
                                    <PopoverButton className="relative inline-flex items-center justify-center rounded-md bg-white p-2 text-slate-400 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500">
                                        <span className="absolute -inset-0.5" />
            ...
            <main>
                ...
                {/* CTA Section */}
                <section aria-labelledby="join-heading" className="relative bg-white">
                    <div aria-hidden="true" className="absolute inset-x-0 hidden h-1/2 bg-slate-50 lg:block" />
                    <div className="mx-auto max-w-7xl bg-blue-600 lg:bg-transparent lg:px-8">
                        <div className="lg:grid lg:grid-cols-12">
                            <div className="relative z-10 lg:col-span-4 lg:col-start-1 lg:row-start-1 lg:bg-transparent lg:py-16">
                                <div aria-hidden="true" className="absolute inset-x-0 h-1/2 bg-slate-50 lg:hidden" />
                                ...
                                <div aria-hidden="true" className="absolute inset-0 hidden overflow-hidden rounded-3xl lg:block">
                                    ...
                                    >
                                        <defs>
                                            ...
                                            >
                                                <rect x={0} y={0} fill="currentColor" width={4} height={4} className="text-blue-500" />
                                            </pattern>
                                        </defs>
                ...
                >
                    <div className="lg:w-0 lg:flex-1">
                        <h2 id="newsletter-heading" className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            ...
            <footer aria-labelledby="footer-heading" className="bg-slate-50">
                ...
                <div className="mx-auto max-w-md px-6 py-12 sm:max-w-7xl lg:px-8 lg:py-16">
                    <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                        <div className="space-y-8 xl:col-span-1">
                            <img
                                alt="Company name"
                                src="https://tailwindui.com/plus/img/logos/mark.svg?color=blueGray&shade=300"
                                className="h-10"
                            />
