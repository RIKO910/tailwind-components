    ...
    return (
        <section className="bg-indigo-800">
            <div className="mx-auto max-w-7xl md:grid md:grid-cols-2 md:px-6 lg:px-8">
                <div className="px-6 py-12 md:flex md:flex-col md:border-r md:border-indigo-900 md:py-16 md:pl-0 md:pr-10 lg:pr-16">
                    <div className="md:flex-shrink-0">
                        <img alt="Tuple" src="https://tailwindui.com/plus/img/logos/tuple-logo-indigo-300.svg" className="h-12" />
                    </div>
                    <blockquote className="mt-6 md:flex md:flex-grow md:flex-col">
                        <div className="relative text-lg font-medium text-white md:flex-grow">
                            <svg
                                ...
                                viewBox="0 0 32 32"
                                aria-hidden="true"
                                className="absolute left-0 top-0 h-8 w-8 -translate-x-3 -translate-y-2 transform text-indigo-600"
                            >
                ...
                <div className="border-t-2 border-indigo-900 px-6 py-12 md:border-l md:border-t-0 md:py-16 md:pl-10 md:pr-0 lg:pl-16">
                    <div className="md:flex-shrink-0">
                        <img
                            alt="Workcation"
                            src="https://tailwindui.com/plus/img/logos/workcation-logo-indigo-300.svg"
                            className="h-12"
                        />
                    </div>
                    <blockquote className="mt-6 md:flex md:flex-grow md:flex-col">
