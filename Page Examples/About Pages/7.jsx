                ...
                <div className="bg-purple-400">
                    <div className="mx-auto max-w-md px-6 py-16 text-center sm:max-w-2xl sm:py-24 lg:px-8 lg:py-32">
                        ...
                        >
                            ...
                            <ArrowTopRightOnSquareIcon aria-hidden="true" className="ml-3 h-5 w-5 flex-shrink-0 text-gray-400" />
                        </a>
                    </div>
                </div>
            </main>
                ...
                <div className="mx-auto max-w-md px-6 py-12 sm:max-w-lg sm:pt-16 lg:max-w-7xl lg:px-8 lg:pb-16 lg:pt-24">
                    <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                        <div className="space-y-8 xl:col-span-1">
                            <img
                                alt="Company name"
                                src="https://tailwindui.com/plus/img/logos/mark.svg?color=gray&shade=400"
                                className="h-10"
                            />
