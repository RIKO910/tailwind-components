            ...
            <div className="flex min-h-full">
                <Dialog open={sidebarOpen} onClose={setSidebarOpen} className="relative z-40 lg:hidden">
                    ...
                    <div className="fixed inset-0 z-40 flex">
                        <DialogPanel
                            transition
                            className="relative flex w-full max-w-xs flex-1 transform flex-col bg-gray-800 pb-4 pt-5 transition duration-300 ease-in-out data-[closed]:-translate-x-full"
                        >
                            <TransitionChild>
                                            ...
                                            <div className="md:flex md:items-center md:justify-between md:space-x-4 xl:border-b xl:pb-6">
                                                ...
                                                <div className="mt-4 flex space-x-3 md:mt-0">
                                                    ...
                                                    <button
                                                        ...
                                                        className="inline-flex justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                                                    >
                                                        <BellIcon aria-hidden="true" className="-ml-0.5 h-5 w-5 text-gray-400" />
                                                        Subscribe
                                                    </button>
                                                </div>
                                            </div>
                                            <aside className="mt-8 xl:hidden">
                                                ...
                                                <div className="space-y-5">
                                                    <div className="flex items-center space-x-2">
                                                        <LockOpenIcon aria-hidden="true" className="h-5 w-5 text-green-500" />
                                                                ...
                                                                <form action="#">
                                                                    ...
                                                                    <div className="mt-6 flex items-center justify-end space-x-4">
                                                                        <button
                                                                            ...
                                                                            className="inline-flex justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                                                                        >
                                                                            <CheckCircleIcon aria-hidden="true" className="-ml-0.5 h-5 w-5 text-green-500" />
                                                                            Close issue
                                                                        </button>
                                                                        <button
                                                                            type="submit"
