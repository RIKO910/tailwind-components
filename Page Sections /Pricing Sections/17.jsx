                    ...
                    <div className="flex w-full items-stretch border-t border-gray-200">
                        ...
                        {plans.map((plan, planIdx) => (
                            <div
                                key={plan.title}
                                aria-hidden="true"
                                className={classNames(planIdx === plans.length - 1 ? '' : 'pr-4', '-mt-px w-1/4 pl-4')}
                            >
                                <div
                                    className={classNames(plan.featured ? 'border-indigo-600' : 'border-transparent', 'border-t-2 py-6')}
                                >
